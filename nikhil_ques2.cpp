 ...
 */
 // This program has been made by taking  help from Sanfoundry as I was absent in stack and queues class
#include<stdio.h>
#include<iostream>
#include<conio.h>
using namespace std;
...
{
    cout<<" ****** Program to display popped value from stack ******";
    int n, x, i = 0;
    cout<<"\n How many elements do you want to enter in the stack? \n";
    cin>>n;
    while (i < n)
    {
